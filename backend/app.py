...
# ── Redirect client‐side routes back to root ────────────────────────────────
...
def process_frame():
    ...
    # ── EARLY GUARD ── skip empty/malformed payloads
    ...
    try:
        ...
        # cache for next empty‐payload guard
        ...
        # on any error, return last known state
...
def process_finger_frame():
    ...
    try:
        ...
        # reset state per‐call for finger‐sign
...
# ── SPA routing: serve React build for anything else ────────────────────────
